...
<main id="content" role="main" class="main">
    {{-- <div class="position-fixed top-0 right-0 left-0 bg-img-hero"
         style="height: 100%; background-image: url({{asset('public/assets/admin')}}/svg/components/bg.jpg);">
    </div> --}}
    ...
    <div class="container py-5 py-sm-7">
        {{-- <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2"
                 ...
                 alt="Image Description" style="height: 100px;">
        </a> --}}
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        ...
                        <form class="js-validate" action="{{route('admin.auth.login')}}" method="post">
                            ...
                            <button type="submit"
                                    class="btn btn-lg btn-block btn-primary">{{\App\CentralLogics\translate('sign_in')}}</button>
                        </form>
                        <!-- End Form -->
                    </div>

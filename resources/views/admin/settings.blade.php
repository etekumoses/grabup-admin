                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="userNameLabel" class="col-sm-3 col-form-label input-label">Username <i
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{"form_alert('admin-settings-form','Want to update admin info ?')"}}" class="btn btn-primary">Save changes</button>
                            </div>
